...
if __name__ == '__main__':
    ...
    save_dict = torch.load('models/swingnet_pose_estimation_adj3.pth.tar')
    ...
    with open('evaluation_results_pose_estimation_adj3.txt', 'w') as file:
    ...
    print(f'Evaluation complete. Results saved to "evaluation_results_pose_estimation_adj3.txt".')
